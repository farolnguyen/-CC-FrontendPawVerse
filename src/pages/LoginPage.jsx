  ...
  return (
    <div className="login-page">
      ...
      <div className="login-logo">
        <div className="login-paw-icon">
          <div className="login-paw-pads">
            <span></span>
          </div>
        </div>
      </div>
      ...
      <div className="login-title-section">
        <h1 className="login-title">
          ĐĂNG NHẬP <span className="login-brand">PAWVERSE</span>
        </h1>
        <p className="login-subtitle">Chào mừng trở lại với ngôi nhà thú cưng</p>
      </div>
