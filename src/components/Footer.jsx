      ...
      <div className="footer-container">
        <div className="footer-left">
          ...
          <p className="footer-description">
            PawVerse.vn là trang mua sắm trực tuyến các sản phẩm<br />
            bán lẻ dành cho thú cưng của PawVerse Pet Shop. Công<br />
            ty TNHH PawVerse.
          </p>
        ...
        <div className="footer-contact">
          <h4>Store</h4>
          <p>
            10/80c Song Hành Xa Lộ Hà Nội, Phường Tân Phú, Thủ Đức,<br />
            Hồ Chí Minh
          </p>
          <p>+84 329222698</p>
          <p>pawverse@gmail.com</p>
        </div>
      </div>
    </footer>
  );
